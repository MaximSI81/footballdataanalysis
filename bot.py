...
# Словарь лиг и турниров (без изменений)
LEAGUES = {
...
# ОПТИМИЗИРОВАННЫЕ КАТЕГОРИИ БЕЗ ДУБЛИРОВАНИЯ
MAIN_CATEGORIES = {
    "📊 Общий обзор": "overview",
    "⚽ Атака": "attack", 
    "🛡️ Базовая статистика": "basic_stats",
    "📈 Форма и H2H": "form_h2h",
    "💰 Прогнозы и ставки": "predictions_betting",
    "⭐ Игроки": "players",
    "📋 Полный отчет": "full_report",
    "🔙 Назад к выбору команд": "back_to_teams"
}

# ПОДКАТЕГОРИИ БЕЗ ДУБЛИРОВАНИЯ
SUB_CATEGORIES = {
    "overview": {
        "📊 Весь раздел 'Обзор'": "overview_all",
        "📊 Сводная таблица": "overview_summary",
        "⚡ Быстрые выводы": "overview_insights",
        "🔙 Назад к разделам": "back_to_main"
    },
    "attack": {
        "⚽ Весь раздел 'Атака'": "attack_all",
        "⚽ Голы и результативность": "attack_goals",
        "🎯 Удары и xG": "attack_shots_xg", 
        "🔄 Эффективность атаки": "attack_efficiency",
        "🎯 Зоны атаки и фланги": "attack_zones",
        "🔙 Назад к разделам": "back_to_main"
    },
    "basic_stats": {
        "🛡️ Весь раздел 'Статистика'": "stats_all",
        "⚖️ Владение мячом": "stats_possession",
        "🔄 Пасы и контроль": "stats_passing",
        "🎪 Качество моментов": "stats_quality",
        "🔙 Назад к разделам": "back_to_main"
    },
    "form_h2h": {
        "📈 Весь раздел 'Форма'": "form_h2h_all",
        "📅 Текущая форма": "form_recent", 
        "🤝 История встреч": "form_h2h",
        "🏠 Дома/в гостях": "form_home_away",
        "🔙 Назад к разделам": "back_to_main"
    },
    "predictions_betting": {
        "💰 Весь раздел 'Прогнозы'": "predictions_all",
        "🎯 Вероятности исходов": "predictions_probabilities",
        "💰 Рекомендации по ставкам": "predictions_recommendations",
        "🟨 Прогноз карточек и дисциплина": "predictions_cards",
        "📈 Эксклюзивные прогнозы": "predictions_exclusive",
        "🔙 Назад к разделам": "back_to_main"
    },
    "players": {
        "⭐ Весь раздел 'Игроки'": "players_all",
        "⭐ Ключевые игроки": "players_key",
        "📊 Форма игроков": "players_form",
        "🔙 Назад к разделам": "back_to_main"
    }
}

# СТРУКТУРА СЕКЦИЙ БЕЗ ДУБЛИРОВАНИЯ
SECTION_MAPPING = {
    # === ОБЩИЙ ОБЗОР ===
    "overview_summary": {
        "sections": ["🏆 ПОЗИЦИЯ В ТАБЛИЦЕ", "⚽ РЕЗУЛЬТАТИВНОСТЬ", "🎯 УДАРЫ", 
                    "📈 РЕАЛЬНЫЙ xG", "🎯 ЭФФЕКТИВНОСТЬ РЕАЛИЗАЦИИ", "📊 КОНТРОЛЬ ИГРЫ", 
                    "🔄 ТОЧНОСТЬ ПЕРЕДАЧ", "🛡️ ОБОРОНА", "🎯 СТАТИСТИКА УГЛОВЫХ", "🎪 КАЧЕСТВО МОМЕНТОВ"]
    },
    "overview_insights": {
    ...
    "overview_all": {
        "sections": ["🏆 ПОЗИЦИЯ В ТАБЛИЦЕ", "⚽ РЕЗУЛЬТАТИВНОСТЬ", "🎯 УДАРЫ", 
                    "📈 РЕАЛЬНЫЙ xG", "🎯 ЭФФЕКТИВНОСТЬ РЕАЛИЗАЦИИ", "📊 КОНТРОЛЬ ИГРЫ", 
                    "🔄 ТОЧНОСТЬ ПЕРЕДАЧ", "🛡️ ОБОРОНА", "🎪 КАЧЕСТВО МОМЕНТОВ", 
                    "📈 КЛЮЧЕВЫЕ ИНСАЙТЫ", "🎯 СТАТИСТИКА УГЛОВЫХ", "📊 ОЖИДАЕМАЯ АКТИВНОСТЬ"]
    },
    
    # === АТАКА ===
    "attack_corners": {
        "sections": ["🎯 СТАТИСТИКА УГЛОВЫХ", "📊 ОЖИДАЕМАЯ АКТИВНОСТЬ"]
    },
    "attack_goals": {
    ...
    "attack_zones": {
        "sections": ["🔄 АКТИВНОСТЬ ФЛАНГОВ", "🎯 ДАЛЬНИЕ АТАКИ", 
                    "🎯 АНАЛИЗ ЗОН АТАК И УЯЗВИМОСТЕЙ", "🏹 АТАКУЕТ", "🎯 СТАТИСТИКА УГЛОВЫХ", "📊 ОЖИДАЕМАЯ АКТИВНОСТЬ"]
    },
    "attack_all": {
        "sections": ["⚽ РЕЗУЛЬТАТИВНОСТЬ", "🎯 УДАРЫ", "📈 РЕАЛЬНЫЙ xG", 
                    "🎯 ЭФФЕКТИВНОСТЬ РЕАЛИЗАЦИИ", "🔄 АКТИВНОСТЬ ФЛАНГОВ", 
                    "🎯 ДАЛЬНИЕ АТАКИ", "🎯 АНАЛИЗ ЗОН АТАК И УЯЗВИМОСТЕЙ", "🏹 АТАКУЕТ"]
    },
    ...
    "stats_all": {
        "sections": ["📊 КОНТРОЛЬ ИГРЫ", "🔄 ТОЧНОСТЬ ПЕРЕДАЧ", "🛡️ ОБОРОНА", "🎯 СТАТИСТИКА УГЛОВЫХ", "📊 ОЖИДАЕМАЯ АКТИВНОСТЬ", "🎪 КАЧЕСТВО МОМЕНТОВ"]
    },
    ...
    "predictions_cards": {
        "sections": [
            "🟨 АГРЕССИВНОСТЬ", "🟨 ЖЕЛТЫЕ КАРТОЧКИ", "🟨 КАРТОЧКИ У СОПЕРНИКОВ", 
            "📊 АНАЛИЗ АГРЕССИВНОСТИ", "🟨 АНАЛИЗ ДИСЦИПЛИНЫ С УЧЕТОМ РЕФЕРИ",
            "👨‍⚖️ Рефери:", "🎯 Прогноз желтых карточек:", "💰 Рекомендация:", "🎯 Уверенность:"
        ]
    },
    "predictions_exclusive": {
        "sections": ["🎲 ЭКСКЛЮЗИВНЫЕ ПРОГНОЗЫ", "🟨 АНАЛИЗ ДИСЦИПЛИНЫ С УЧЕТОМ РЕФЕРИ",
            "👨‍⚖️ Рефери:", "🎯 Прогноз желтых карточек:", "💰 Рекомендация:", "🎯 Уверенность:",
            "🏠🛬 ПРОГНОЗ РЕЗУЛЬТАТА С УЧЕТОМ ДОМАШНЕГО СТАДИОНА"]
    },
    "predictions_all": {
        "sections": [
            "🏆 ПРОГНОЗ С УЧЕТОМ ПОЗИЦИИ В ТАБЛИЦЕ", "💰 РЕКОМЕНДАЦИИ", 
    ...
    "players_form": {
        "sections": ["⭐ ДЕТАЛЬНЫЙ АНАЛИЗ ФОРМЫ ИГРОКОВ", "🛡️ КОМАНДА:", "⚽ НАПАДАЮЩИЕ", 
                    "🎯 ПОЛУЗАЩИТНИКИ", "🛡️ ЗАЩИТНИКИ", "🥅 ВРАТАРИ"]
    },
    "players_all": {
        "sections": ["⭐ АНАЛИЗ ПРОГРЕССА КЛЮЧЕВЫХ ИГРОКОВ", "🔑 КЛЮЧЕВЫЕ ИГРОКИ", 
                    "⭐ ДЕТАЛЬНЫЙ АНАЛИЗ ФОРМЫ ИГРОКОВ", "🛡️ КОМАНДА:"]
    }
}
...
async def select_league(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        f"Выберите команду хозяев:",
        reply_markup=create_keyboard_with_finish(team_buttons, include_change_league=True)
    )
...
async def select_home_team(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if home_team not in teams:
        team_buttons = [list(teams.keys())[i:i+3] for i in range(0, len(teams), 3)]
        team_buttons.append(["🔄 Сменить лигу"])
    ...
    away_buttons.append(["🔄 Сменить лигу"])
...
def filter_output(output: str, data_type: str) -> str:
    ...
    # Используем новую структуру SECTION_MAPPING
    rule = SECTION_MAPPING.get(data_type, {})
    if not rule:
    ...
    for line in lines:
        ...
        section_keywords = [
            ...
            "КЛЮЧЕВЫЕ", "АТАКУЕТ", "ФЛАНГОВ", "ДАЛЬНИЕ", "ЗОН АТАК", 
            "УЯЗВИМОСТЕЙ", "РЕФЕРИ", "КАРТОЧКИ", "УВЕРЕННОСТЬ"
        ]
...
def get_brief_overview(output: str, data_type: str) -> str:
    ...
    brief_messages = {
        ...
        "overview_insights": "⚡ Быстрые выводы временно недоступны",
        
        # Атака
        "attack_goals": "⚽ Данные о голах временно недоступны",
        "attack_shots_xg": "🎯 Данные об ударах и xG временно недоступны", 
        ...
        "predictions_exclusive": "📈 Эксклюзивные прогнозы временно недоступны",
        
        # Игроки
        "players_key": "⭐️ Анализ ключевых игроков временно недоступен",
        "players_form": "📊 Анализ формы игроков временно недоступен"
    }
...
def main():
    ...
    # УБИРАЕМ ДУБЛИРОВАННЫЕ ОБРАБОТЧИКИ - они уже есть в ConversationHandler
